...
@Component({
  selector: 'app-registration-pet-agency',
  standalone: true,
  imports: [RouterLink, ReactiveFormsModule],
  templateUrl: './registration-pet-agency.component.html',
  styleUrl: './registration-pet-agency.component.css'
})
export class RegistrationPetAgencyComponent {
  ...
  async onSubmit() {
    ...
    const response = await this.authService.registratePetAgency(body);
